...
You will need to have a discord bot first before cloning this repository, you can create one [here](https://discord.com/developers/applications). SauceBot will need the bot and applications.commands scopes selected for it to function as intended.
